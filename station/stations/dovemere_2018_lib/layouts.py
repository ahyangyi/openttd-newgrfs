...
load_central("side_a2", BuildingSpriteSheetSymmetricalY, "A", h_pos=Side, window=["windowed"], borrow_window="side_a")
load_central("side_a3", BuildingSpriteSheetFull, "A", h_pos=Side, window=["windowed"], borrow_window="side_a")
