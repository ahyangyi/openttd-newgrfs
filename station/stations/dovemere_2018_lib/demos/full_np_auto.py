...
row_1 = h_merge([traversable.cb14.demo(i, 1, traversable.cb24_1) for i in range(1, 5)], [[platform_d]])
v_sep = [[concourse_tile] * len(row_1[0])] * 2
row_2 = h_merge([traversable.cb14.demo(i, 2, traversable.cb24_1) for i in range(1, 5)], [[platform_n.T], [platform_n]])
row_4 = h_merge(
    [traversable.cb14.demo(i, 4, traversable.cb24_1) for i in range(1, 5)],
    [[platform_n.T], [platform_n], [platform_n.T], [platform_n]],
)
row_5 = h_merge(
