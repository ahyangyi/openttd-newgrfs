...
station_building = h_merge([side_third.side_third_station_np_demo(i, 1) for i in range(1, 5)], [[cns]])[0]
n = len(station_building)
station_building_2 = h_merge([side_third.side_third_station_np_demo(i, 1) for i in [5, 7]], [[cns]])[0]
