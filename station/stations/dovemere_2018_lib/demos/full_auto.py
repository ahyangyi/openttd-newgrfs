...
from station.stations.dovemere_2018_lib.layouts import named_tiles, platform, platform_s, gray_layout, rail
...
row_4 = h_merge(
    ...
    [[platform_s], [platform_s.T], [platform_s], [platform_s.T]],
)
row_5 = h_merge(
    [traversable.cb14.demo(i, 5, traversable.cb24_0) for i in range(1, 5)],
    [[platform_s], [platform], [platform], [platform], [platform_s.T]],
)
