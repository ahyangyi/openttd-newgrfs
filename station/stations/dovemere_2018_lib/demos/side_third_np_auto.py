...
from station.stations.dovemere_2018_lib.layouts import platform_s, concourse_tile, track
from station.lib.utils import get_1cc_remap
from agrf.graphics.palette import CompanyColour
from station.stations.dovemere_2018_lib.flexible_stations import side_third
from .utils import h_merge

station_building = h_merge([side_third.cb14_2.demo(i, 1) for i in range(1, 5)], [[track]])[0]
n = len(station_building)
station_building_2 = h_merge([side_third.cb14_2.demo(i, 1) for i in [5, 7]], [[track]])[0]
