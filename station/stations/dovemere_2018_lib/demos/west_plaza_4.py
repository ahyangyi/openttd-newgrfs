...
west_square = [
    [center_ground, center_ground, offcenter_A, offcenter_A.R, center_ground, center_ground],
    [center_ground, center_ground, offcenter_B, offcenter_B.R, center_ground, center_ground],
]
