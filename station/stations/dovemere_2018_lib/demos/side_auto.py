...
station_building = h_merge([side.cb14.demo(i, 1) for i in range(1, 5)], [[platform_tiles.concourse_side_shelter_1.T]])[
    0
]
n = len(station_building)
station_building_2 = h_merge([side.cb14.demo(i, 1) for i in [5, 7]], [[platform_tiles.concourse_side_shelter_1.T]])[0]
