...
normal_demo = Demo(
    ...
    [
        ...
        [side_a_n.T, central_windowed, central_windowed_extender, central_windowed.R, side_a_n.T.R],
        [side_b_f.T, central_windowed, central_windowed_extender, central_windowed.R, side_b_f.T.R],
