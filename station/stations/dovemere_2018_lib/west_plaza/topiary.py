...
def make_topiaries():
    make_object_layout("2021a", 0x0100, BuildingSymmetrical, 8, 10, 4, 8, 6)
    make_object_layout("2021b", 0x0120, BuildingSymmetrical, 8, 10, 4, 8, 6)
    make_object_layout("2022a", 0x0130, BuildingSymmetrical, 8, 10, 4, 8, 6)
    make_object_layout("2023b", 0x0160, BuildingSymmetrical, 6, 16, 2, 10, 10)
    make_object_layout("2024a", 0x0170, BuildingSymmetrical, 8, 12, 2, 2, 6, BuildingCylindrical)
    make_object_layout("2024b", 0x0180, BuildingSymmetrical, 8, 12, 2, 2, 6, BuildingCylindrical)
    make_object_layout("2025a", 0x0190, BuildingSymmetrical, 8, 12, 2, 2, 6, BuildingCylindrical)
