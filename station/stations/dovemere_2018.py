...
sprites = (front_normal[2:] + front_normal + central[:2]) + [
    front_gate[2],
    front_gate_flipped[1],
    front_gate_flipped[0],
    front_gate[3],
    corner[0],
    corner_flipped[3],
    corner[2],
    ...
    corner[1],
    central_windowed[0],
    central_windowed_flipped[3],
    central_windowed_flipped[2],
    central_windowed[1],
    front_gate_extender[2],
    front_gate_extender[3],
